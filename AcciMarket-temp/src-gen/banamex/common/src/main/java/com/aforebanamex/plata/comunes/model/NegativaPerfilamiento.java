...
@Bitacora(tipoElemento = "NEGATIVAPERFILAMIENTO")
public class NegativaPerfilamiento extends BaseSerizalizableModel{
	
	private static final long serialVersionUID = 1L;
	
	@BitacoraField(isId = true)
	private long idNegativaPerfilamiento;
	...
	@NotNull(message = "El campo Seleccione la persona que desea perfilar es obligatorio")
	private Dummy dummy;
	@BitacoraField
	...
	@NotNull(message = "El campo Volumen es obligatorio")
	private Dummy dummy;
	@NotNull(message = "El campo 2.6 Títulos Opcionales (Warrant) es obligatorio")
	private Dummy dummy;
	@NotNull(message = "El campo Frecuencia es obligatorio")
	private Dummy dummy;
	@NotNull(message = "El campo Plazo es obligatorio")
	...
	@NotNull(message = "El campo Volumen es obligatorio")
	private Dummy dummy;
	@NotNull(message = "El campo 2.7 Acciones es obligatorio")
	private Dummy dummy;
	@NotNull(message = "El campo Frecuencia es obligatorio")
	private Dummy dummy;
	@NotNull(message = "El campo Plazo es obligatorio")
	...
	@NotNull(message = "El campo Volumen es obligatorio")
	private Dummy dummy;
	@NotNull(message = "El campo 2.8 Valores Extranjeros es obligatorio")
	private Dummy dummy;
	@NotNull(message = "El campo Frecuencia es obligatorio")
	private Dummy dummy;
	@NotNull(message = "El campo Plazo es obligatorio")
	...
	@NotNull(message = "El campo Volumen es obligatorio")
	private Dummy dummy;
	@NotNull(message = "El campo 2.9 Trackers TRACs o ETFs es obligatorio")
	private Dummy dummy;
	@NotNull(message = "El campo Frecuencia es obligatorio")
	private Dummy dummy;
	@NotNull(message = "El campo Plazo es obligatorio")
	...
	@NotNull(message = "El campo Volumen es obligatorio")
	private Dummy dummy;
	@NotNull(message = "El campo 2.5 Certificados de Capital de Desarrollo (CKDs) es obligatorio")
	private Dummy dummy;
	@NotNull(message = "El campo Frecuencia es obligatorio")
	private Dummy dummy;
	@NotNull(message = "El campo Plazo es obligatorio")
	...
	@NotNull(message = "El campo Volumen es obligatorio")
	private Dummy dummy;
	@NotNull(message = "El campo Seleccionar el Propósito de Inversión del Cliente (Estrategia) es obligatorio")
	private Dummy dummy;
	@NotNull(message = "El campo Seleccionar la Torelancia al Riesgo del Cliente es obligatorio")
	private Dummy dummy;
	@NotNull(message = "El campo Seleccionar el Horizonte de Inversión del Cliente es obligatorio")
	private Dummy dummy;
	...
	@BitacoraField
	@Size(min=0,max=99, message="El inconsistencias es incorrecto.")
	...
	public NegativaPerfilamiento(long idNegativaPerfilamiento, 
	Contrato contrato,
	String nombre,
	String perfilActual,
	Dummy dummy,
	...
	Boolean estadoLogico
		...
		super();
		this.idNegativaPerfilamiento = idNegativaPerfilamiento;
	...
	public long getIdNegativaPerfilamiento() {
		return idNegativaPerfilamiento;
	}
	public void setIdNegativaPerfilamiento(long idNegativaPerfilamiento) {
		this.idNegativaPerfilamiento = idNegativaPerfilamiento;
	}
