...
@Component
public class NegativaPerfilamientoHelper extends BaseHelper {
...
List<SituacionFinancieraActual> listaSituacionFinancieraActual= situacionFinancieraActualServices.consultarCatalogoSituacionFinancieraActual();
		...
		model.addAttribute("negativaPerfilamiento", new NegativaPerfilamiento());
		model.addAttribute("negativaPerfilamientoUpd", new NegativaPerfilamiento());
...
model.addAttribute("listaSituacionFinancieraActual", listaSituacionFinancieraActual);
		...
		model.addAttribute(NegativaPerfilamientoConstantesHelper.LISTA_MENSAJES, listaMensajes);
