...
//	datatableInicio();
	...
	$("#consultarNegativaPerfilamientos").hide();
...
var inconsistencias = $("#inconsistenciasFlt").val();
			if(
				contrato === ''
				 && nombre === ''
				 && perfilActual === ''
...
$("#inconsistenciasUpd").prop("readonly", false);
		if ($("input[name='radio']:radio").is(':checked')) {
			...
			$("#idNegativaPerfilamientoUpd").val(row.idNegativaPerfilamiento);
...
$("#inconsistenciasUpd").val(row.inconsistencias);
			$('#modalTitle').empty();
			$('#modalTitle').append('Actualizar informe');
			$('#movModal').modal('show');
			$("#consultarNegativaPerfilamientos").hide();
			$("#updNegativaPerfilamientos").show();
			validarFormUpd();
		}else{
	...
	$('#consultarDetalle').click(function() {
		if ($("input[name='radio']:radio").is(':checked')) {
			$('#formUpd').bootstrapValidator().data('bootstrapValidator').destroy();
			var row = getRowSelected();
				$("#updNegativaPerfilamientos").hide();
...
$("#inconsistenciasUpd").prop("readonly", true);
				//$("#procesoUpd").val(row.proceso);
				//$("#moduloUpd").val(row.modulo);
				//$("#subprocesoUpd").val(row.subproceso);
				$("#idNegativaPerfilamientoUpd").val(row.idNegativaPerfilamiento);
...
$("#perfilUpd").val(row.perfil);
$("#inconsistenciasUpd").val(row.inconsistencias);
				$("#consultarNegativaPerfilamientos").show();									
				$('#modalTitle').empty();
...
$("#perfilUpd").val(row.perfil);
$("#inconsistenciasUpd").val(row.inconsistencias);
				 $("#dominio-mensaje-eliminar").empty().append("&iquest;Desea eliminar el negativa de perfilamiento?");
...
/*	
	...
	$('#com.softtek.rdl2.impl.EntityImpl@56d4bd13 (name: NegativaPerfilamiento)').val('');
	});
	
	$('#com.softtek.rdl2.impl.EntityImpl@56d4bd13 (name: NegativaPerfilamiento)').on('input', function() {
...
function datatableInicio() {
	...
	jsonAjax(contextPath + "obtenerNegativaPerfilamientosActivo",modelo,inicioDatos);
}

function buscarNegativaPerfilamientos() {
	...
	var model = {
			...
			"payload":{
				...
				,"inconsistencias": $("#inconsistenciasFlt").val()
			}
	}
	console.log(model);
		$.ajax({
			...
			url : contextPath + "obtenerNegativaPerfilamientos",
	...
	$("#verNegativaPerfilamientos").show();
}
...
function obtenerDummy(){
	...
	var expTitulosOpc = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (expTitulosOpc === undefined){
			return 2; // estado activo para busquedas en ejecucion de expTitulosOpc
		}
	}
	
	return expTitulosOpc;
}	

function obtenerDummyFlt(){
	
	var expTitulosOpc = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var frecuenciaTitulosOpc = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (frecuenciaTitulosOpc === undefined){
			return 2; // estado activo para busquedas en ejecucion de frecuenciaTitulosOpc
		}
	}
	
	return frecuenciaTitulosOpc;
}	

function obtenerDummyFlt(){
	
	var frecuenciaTitulosOpc = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var plazoTitulosOpc = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (plazoTitulosOpc === undefined){
			return 2; // estado activo para busquedas en ejecucion de plazoTitulosOpc
		}
	}
	
	return plazoTitulosOpc;
}	

function obtenerDummyFlt(){
	
	var plazoTitulosOpc = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var volumenTitulosOpc = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (volumenTitulosOpc === undefined){
			return 2; // estado activo para busquedas en ejecucion de volumenTitulosOpc
		}
	}
	
	return volumenTitulosOpc;
}	

function obtenerDummyFlt(){
	
	var volumenTitulosOpc = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var expAcciones = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (expAcciones === undefined){
			return 2; // estado activo para busquedas en ejecucion de expAcciones
		}
	}
...
function obtenerDummyFlt(){
	...
	var expAcciones = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var frecuenciaAcciones = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (frecuenciaAcciones === undefined){
			return 2; // estado activo para busquedas en ejecucion de frecuenciaAcciones
		}
	}
	
	return frecuenciaAcciones;
}	

function obtenerDummyFlt(){
	
	var frecuenciaAcciones = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var plazoAcciones = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (plazoAcciones === undefined){
			return 2; // estado activo para busquedas en ejecucion de plazoAcciones
		}
	}
	
	return plazoAcciones;
}	

function obtenerDummyFlt(){
	
	var plazoAcciones = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var volumenAcciones = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (volumenAcciones === undefined){
			return 2; // estado activo para busquedas en ejecucion de volumenAcciones
		}
	}
...
function obtenerDummyFlt(){
	...
	var volumenAcciones = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var expValoresExt = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (expValoresExt === undefined){
			return 2; // estado activo para busquedas en ejecucion de expValoresExt
		}
	}
	
	return expValoresExt;
}	

function obtenerDummyFlt(){
	
	var expValoresExt = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var frecuenciaValoresExt = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (frecuenciaValoresExt === undefined){
			return 2; // estado activo para busquedas en ejecucion de frecuenciaValoresExt
		}
	}
	
	return frecuenciaValoresExt;
}	

function obtenerDummyFlt(){
	
	var frecuenciaValoresExt = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var plazoValoresExt = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (plazoValoresExt === undefined){
			return 2; // estado activo para busquedas en ejecucion de plazoValoresExt
		}
	}
	
	return plazoValoresExt;
}	

function obtenerDummyFlt(){
	
	var plazoValoresExt = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var volumenValoresExt = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (volumenValoresExt === undefined){
			return 2; // estado activo para busquedas en ejecucion de volumenValoresExt
		}
	}
	
	return volumenValoresExt;
}	

function obtenerDummyFlt(){
	
	var volumenValoresExt = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var expTrackers = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (expTrackers === undefined){
			return 2; // estado activo para busquedas en ejecucion de expTrackers
		}
	}
...
function obtenerDummyFlt(){
	...
	var expTrackers = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var frecuenciaTrackers = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (frecuenciaTrackers === undefined){
			return 2; // estado activo para busquedas en ejecucion de frecuenciaTrackers
		}
	}
	
	return frecuenciaTrackers;
}	

function obtenerDummyFlt(){
	
	var frecuenciaTrackers = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var plazoTrackers = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (plazoTrackers === undefined){
			return 2; // estado activo para busquedas en ejecucion de plazoTrackers
		}
	}
	
	return plazoTrackers;
}	

function obtenerDummyFlt(){
	
	var plazoTrackers = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var volumenTrackers = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (volumenTrackers === undefined){
			return 2; // estado activo para busquedas en ejecucion de volumenTrackers
		}
	}
	
	return volumenTrackers;
}	

function obtenerDummyFlt(){
	
	var volumenTrackers = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var expCertificadosCap = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (expCertificadosCap === undefined){
			return 2; // estado activo para busquedas en ejecucion de expCertificadosCap
		}
	}
	
	return expCertificadosCap;
}	

function obtenerDummyFlt(){
	
	var expCertificadosCap = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var frecuenciaCertificadosCap = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (frecuenciaCertificadosCap === undefined){
			return 2; // estado activo para busquedas en ejecucion de frecuenciaCertificadosCap
		}
	}
	
	return frecuenciaCertificadosCap;
}	

function obtenerDummyFlt(){
	
	var frecuenciaCertificadosCap = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var plazoCertificadosCap = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (plazoCertificadosCap === undefined){
			return 2; // estado activo para busquedas en ejecucion de plazoCertificadosCap
		}
	}
	
	return plazoCertificadosCap;
}	

function obtenerDummyFlt(){
	
	var plazoCertificadosCap = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var volumenCertificadosCap = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (volumenCertificadosCap === undefined){
			return 2; // estado activo para busquedas en ejecucion de volumenCertificadosCap
		}
	}
	
	return volumenCertificadosCap;
}	

function obtenerDummyFlt(){
	
	var volumenCertificadosCap = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var propositoInversion = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (propositoInversion === undefined){
			return 2; // estado activo para busquedas en ejecucion de propositoInversion
		}
	}
	
	return propositoInversion;
}	

function obtenerDummyFlt(){
	
	var propositoInversion = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var toleranciaRiesgo = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (toleranciaRiesgo === undefined){
			return 2; // estado activo para busquedas en ejecucion de toleranciaRiesgo
		}
	}
...
function obtenerDummyFlt(){
	...
	var toleranciaRiesgo = $("#cveDummyFlt").val();
...
function obtenerDummy(){
	...
	var horizonteInversion = $("#cveDummy").val();
	
	if ($(location).attr("href").indexOf('ejecucion') != -1){
		if (horizonteInversion === undefined){
			return 2; // estado activo para busquedas en ejecucion de horizonteInversion
		}
	}
	
	return horizonteInversion;
}	

function obtenerDummyFlt(){
	
	var horizonteInversion = $("#cveDummyFlt").val();
...
function registrarNegativaPerfilamientos() {	
		var data = getObject();	
			$.ajax({
				type : 'POST',
				contentType : 'application/json; charset=utf-8',
				url : contextPath + "registrarNegativaPerfilamiento",
				...
				success : function(data) {
					if (data.codigoEstatus === 400){
						mostrarAlertDanger("Ya existe una negativa de perfilamiento con esa configuraci\u00f3n", 'alertDanger');
					} else if (data.codigoEstatus === 404) {
						mostrarAlertDanger('No existe la plantilla especificada en el servidor', 'alertDanger');
					} else {
						mostrarAlertSuccess('El negativa de perfilamiento se agreg\u00f3 exitosamente');
						tablaVacia();
...
function actualizarNegativaPerfilamiento(){
	var data = getObjectUpd();
		$.ajax({
			type : 'POST',
			contentType : 'application/json; charset=utf-8',
			url : contextPath + "actualizarNegativaPerfilamiento",
			data: JSON.stringify(data),
			dataType: 'json',
			cache : false,
			processData : false,
			success : function(data) {
				if (data.codigoEstatus === 400){
					mostrarAlertDanger("Ya existe una negativa de perfilamiento con esa configuraci\u00f3n", 'alertDangerUp');
				} else {
...
function eliminarNegativaPerfilamiento() {
	var data = getObjectUpd();
	
	$.ajax({
		type : 'POST',
		contentType : 'application/json; charset=utf-8',
		url : contextPath + "eliminarNegativaPerfilamiento/"+$("#idNegativaPerfilamientoUpd").val(),
		dataType: 'json',
		cache : false,
		processData : false,
		success : function(data) {
...
function getObject() {
	...
	var data = {			
			...
			,"perfil": $("#perfil").val()
			,"inconsistencias": $("#inconsistencias").val()
	};
	return data;
}
...
function getObjectUpd() {
	...
	var row = getRowSelected();
	var data = {
			"idNegativaPerfilamiento" : $("#idNegativaPerfilamientoUpd").val(),
			"contrato": {
			...
			,"inconsistencias": $("#inconsistenciasUpd").val()
...
function validarForm(){
	$('#formNew').bootstrapValidator({
        ...
        registrarNegativaPerfilamientos();
    });
...
function validarFormUpd(){
	$('#formUpd').bootstrapValidator({
        ...
        var $form = $(e.target);
        var bv = $form.data('bootstrapValidator');
        actualizarNegativaPerfilamiento();
    });
}


//Tiempo de ejecucion
function verNegativaPerfilamiento(){
	...
	if ($("input[name='radio']:radio").is(':checked')) {
		...
		var data = {
				...
				"payload" : {
					"idNegativaPerfilamiento" : row.idNegativaPerfilamiento,
	         		...
	         		,"dummy" : row.expTitulosOpc
	         		,"dummy" : row.frecuenciaTitulosOpc
	         		,"dummy" : row.plazoTitulosOpc
	         		,"dummy" : row.volumenTitulosOpc
	         		,"dummy" : row.expAcciones
	         		,"dummy" : row.frecuenciaAcciones
	         		,"dummy" : row.plazoAcciones
	         		,"dummy" : row.volumenAcciones
	         		,"dummy" : row.expValoresExt
	         		,"dummy" : row.frecuenciaValoresExt
	         		,"dummy" : row.plazoValoresExt
	         		,"dummy" : row.volumenValoresExt
	         		,"dummy" : row.expTrackers
	         		,"dummy" : row.frecuenciaTrackers
	         		,"dummy" : row.plazoTrackers
	         		,"dummy" : row.volumenTrackers
	         		,"dummy" : row.expCertificadosCap
	         		,"dummy" : row.frecuenciaCertificadosCap
	         		,"dummy" : row.plazoCertificadosCap
	         		,"dummy" : row.volumenCertificadosCap
	         		,"dummy" : row.propositoInversion
	         		,"dummy" : row.toleranciaRiesgo
	         		,"dummy" : row.horizonteInversion
		...
		$.ajax({
			type : 'POST',
			contentType : 'application/json; charset=utf-8',
			url : contextPath + "paramsNegativaPerfilamiento",
			data: JSON.stringify(data),
			dataType: 'json',
			cache : false,
			processData : false,
			success : function(data) {
				...
				if (data.payload.existePlantilla === true){
					window.location.href = contextPath + 'parametrosNegativaPerfilamiento?reporte=' + data.payload.nomPlantilla + '&rutaSalida=' + data.payload.rutaPlantilla+'&contrato='+data.payload.contrato.idContrato
					...
					+'&inconsistencias='+data.payload.inconsistencias
					;
				}else{
...
function iniciarTabla(){
	...
	jsonAjax(contextPath + "obtenerNegativaPerfilamientos",modelo,inicioDatos);
}
