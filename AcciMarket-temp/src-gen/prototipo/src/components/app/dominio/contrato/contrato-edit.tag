...
<contrato-edit>
	<page id="contrato-edit" title="Editar Contrato">
		<formbox title="Datos de Contrato" icon="fa fa-check-circle-o" action="update" return="/dominio/contrato/contrato-admin">
			<div class="row">
				<div class="col-md-6">	
			...
			<p hidden>33</p>
				...
				<select-auto id="instrdeudagub" placeholder="Instrumetos de Deuda Gubernamental" required=true disabled=false>
					<option id="oGnbtdbD" label="Voluptatem sunt numquam consequatur provident debitis." />
					<option id="k87ArVAK" label="Et commodi architecto quas modi aut sapiente." />
					<option id="wENKfbnM" label="Nemo facere omnis molestiae cupiditate voluptatibus voluptas ut." />
					<option id="BzY8w0MJ" label="Nostrum voluptas omnis qui modi." />
					<option id="QuObjv2m" label="Qui expedita nihil sed dolores." />
				</select-auto>
				</div>
			</div>
