...
<titularcontrato-edit>
	<page id="titularcontrato-edit" title="Editar Titular">
		<formbox title="Datos de Titular" icon="fa fa-check-circle-o" action="update" return="/dominio/titularcontrato/titularContrato-admin">
			<div class="row">
				<div class="col-md-6">	
