...
public class NegativaPerfilamientoBean extends BaseModel<NegativaPerfilamientoPkBean> {
...
@Getter @Setter private String inconsistencias;
	@Getter @Setter private NegativaPerfilamientoPkBean id;
