...
public class BeneficiarioByPorcentajeSpecification extends BaseSpecification<Beneficiario> {

  private final String name;

  public BeneficiarioByPorcentajeSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Beneficiario> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Beneficiario_.porcentaje), "%"+this.name+"%");
  }
