...
public class ContratoByFechaElegibleSpecification extends BaseSpecification<Contrato> {

  private final String name;

  public ContratoByFechaElegibleSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Contrato> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Contrato_.fechaelegible), "%"+this.name+"%");
  }
