...
public class ContratoByFechaSofisticadoSpecification extends BaseSpecification<Contrato> {

  private final String name;

  public ContratoByFechaSofisticadoSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Contrato> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Contrato_.fechasofisticado), "%"+this.name+"%");
  }
