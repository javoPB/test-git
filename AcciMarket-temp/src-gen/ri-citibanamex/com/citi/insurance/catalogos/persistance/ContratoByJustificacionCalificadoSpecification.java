...
public class ContratoByJustificacionCalificadoSpecification extends BaseSpecification<Contrato> {

  private final String name;

  public ContratoByJustificacionCalificadoSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Contrato> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Contrato_.justificacioncalificado), "%"+this.name+"%");
  }
