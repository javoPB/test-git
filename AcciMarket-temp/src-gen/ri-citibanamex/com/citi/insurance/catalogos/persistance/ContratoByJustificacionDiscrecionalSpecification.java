...
public class ContratoByJustificacionDiscrecionalSpecification extends BaseSpecification<Contrato> {

  private final String name;

  public ContratoByJustificacionDiscrecionalSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Contrato> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Contrato_.justificaciondiscrecional), "%"+this.name+"%");
  }
