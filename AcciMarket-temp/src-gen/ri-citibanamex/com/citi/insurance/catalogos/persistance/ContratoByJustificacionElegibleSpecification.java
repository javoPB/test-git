...
public class ContratoByJustificacionElegibleSpecification extends BaseSpecification<Contrato> {

  private final String name;

  public ContratoByJustificacionElegibleSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Contrato> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Contrato_.justificacionelegible), "%"+this.name+"%");
  }
