...
public class ContratoByJustificacionInstitucionalSpecification extends BaseSpecification<Contrato> {

  private final String name;

  public ContratoByJustificacionInstitucionalSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Contrato> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Contrato_.justificacioninstitucional), "%"+this.name+"%");
  }
