...
public class ContratoByJustificacionSofisticadoSpecification extends BaseSpecification<Contrato> {

  private final String name;

  public ContratoByJustificacionSofisticadoSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Contrato> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Contrato_.justificacionsofisticado), "%"+this.name+"%");
  }
