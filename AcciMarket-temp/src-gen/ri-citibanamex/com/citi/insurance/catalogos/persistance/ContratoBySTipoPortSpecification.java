...
public class ContratoBySTipoPortSpecification extends BaseSpecification<Contrato> {

  private final String name;

  public ContratoBySTipoPortSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Contrato> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Contrato_.stipoport), "%"+this.name+"%");
  }
