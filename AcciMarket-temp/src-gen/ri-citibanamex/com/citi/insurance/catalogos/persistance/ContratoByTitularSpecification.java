...
public class ContratoByTitularSpecification extends BaseSpecification<Contrato> {

  private final String name;

  public ContratoByTitularSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Contrato> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Contrato_.titular), "%"+this.name+"%");
  }
