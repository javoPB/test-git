...
public class DistribucioninstruccionesByCapturadosSpecification extends BaseSpecification<Distribucioninstrucciones> {

  private final String name;

  public DistribucioninstruccionesByCapturadosSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Distribucioninstrucciones> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Distribucioninstrucciones_.capturados), "%"+this.name+"%");
  }
