...
public class DistribucioninstruccionesByContratoSpecification extends BaseSpecification<Distribucioninstrucciones> {

  private final String name;

  public DistribucioninstruccionesByContratoSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Distribucioninstrucciones> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Distribucioninstrucciones_.contrato), "%"+this.name+"%");
  }
