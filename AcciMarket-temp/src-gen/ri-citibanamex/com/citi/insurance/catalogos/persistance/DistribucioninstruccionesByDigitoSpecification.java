...
public class DistribucioninstruccionesByDigitoSpecification extends BaseSpecification<Distribucioninstrucciones> {

  private final String name;

  public DistribucioninstruccionesByDigitoSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Distribucioninstrucciones> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Distribucioninstrucciones_.digito), "%"+this.name+"%");
  }
