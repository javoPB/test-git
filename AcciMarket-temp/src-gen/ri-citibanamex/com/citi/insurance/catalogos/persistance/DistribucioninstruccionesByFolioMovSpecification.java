...
public class DistribucioninstruccionesByFolioMovSpecification extends BaseSpecification<Distribucioninstrucciones> {

  private final String name;

  public DistribucioninstruccionesByFolioMovSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Distribucioninstrucciones> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Distribucioninstrucciones_.foliomov), "%"+this.name+"%");
  }
