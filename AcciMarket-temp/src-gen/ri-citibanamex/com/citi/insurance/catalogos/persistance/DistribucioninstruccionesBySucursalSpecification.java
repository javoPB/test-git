...
public class DistribucioninstruccionesBySucursalSpecification extends BaseSpecification<Distribucioninstrucciones> {

  private final String name;

  public DistribucioninstruccionesBySucursalSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Distribucioninstrucciones> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Distribucioninstrucciones_.sucursal), "%"+this.name+"%");
  }
