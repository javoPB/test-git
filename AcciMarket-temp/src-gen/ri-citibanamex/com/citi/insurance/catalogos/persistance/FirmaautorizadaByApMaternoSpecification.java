...
public class FirmaautorizadaByApMaternoSpecification extends BaseSpecification<Firmaautorizada> {

  private final String name;

  public FirmaautorizadaByApMaternoSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Firmaautorizada> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Firmaautorizada_.apmaterno), "%"+this.name+"%");
  }
