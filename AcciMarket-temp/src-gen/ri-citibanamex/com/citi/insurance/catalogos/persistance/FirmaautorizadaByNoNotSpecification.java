...
public class FirmaautorizadaByNoNotSpecification extends BaseSpecification<Firmaautorizada> {

  private final String name;

  public FirmaautorizadaByNoNotSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Firmaautorizada> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Firmaautorizada_.nonot), "%"+this.name+"%");
  }
