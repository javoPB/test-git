...
public class FirmaautorizadaByNombreSpecification extends BaseSpecification<Firmaautorizada> {

  private final String name;

  public FirmaautorizadaByNombreSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Firmaautorizada> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Firmaautorizada_.nombre), "%"+this.name+"%");
  }
