...
public class FirmaautorizadaByTipoSpecification extends BaseSpecification<Firmaautorizada> {

  private final String name;

  public FirmaautorizadaByTipoSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Firmaautorizada> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Firmaautorizada_.tipo), "%"+this.name+"%");
  }
