...
public class InstruccionefectivoByContratoIngresoSpecification extends BaseSpecification<Instruccionefectivo> {

  private final String name;

  public InstruccionefectivoByContratoIngresoSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Instruccionefectivo> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Instruccionefectivo_.contratoingreso), "%"+this.name+"%");
  }
