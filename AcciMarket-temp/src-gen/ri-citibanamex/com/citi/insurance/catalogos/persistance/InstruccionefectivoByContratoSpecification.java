...
public class InstruccionefectivoByContratoSpecification extends BaseSpecification<Instruccionefectivo> {

  private final String name;

  public InstruccionefectivoByContratoSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Instruccionefectivo> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Instruccionefectivo_.contrato), "%"+this.name+"%");
  }
