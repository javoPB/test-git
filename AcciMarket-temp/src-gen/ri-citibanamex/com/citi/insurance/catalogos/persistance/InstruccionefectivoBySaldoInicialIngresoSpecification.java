...
public class InstruccionefectivoBySaldoInicialIngresoSpecification extends BaseSpecification<Instruccionefectivo> {

  private final String name;

  public InstruccionefectivoBySaldoInicialIngresoSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Instruccionefectivo> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Instruccionefectivo_.saldoinicialingreso), "%"+this.name+"%");
  }
