...
public class InstruccionefectivoBySucursalSpecification extends BaseSpecification<Instruccionefectivo> {

  private final String name;

  public InstruccionefectivoBySucursalSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Instruccionefectivo> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Instruccionefectivo_.sucursal), "%"+this.name+"%");
  }
