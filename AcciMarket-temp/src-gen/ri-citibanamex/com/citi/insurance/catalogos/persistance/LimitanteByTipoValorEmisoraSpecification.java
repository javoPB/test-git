...
public class LimitanteByTipoValorEmisoraSpecification extends BaseSpecification<Limitante> {

  private final String name;

  public LimitanteByTipoValorEmisoraSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Limitante> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Limitante_.tipovaloremisora), "%"+this.name+"%");
  }
