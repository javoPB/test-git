...
public class LimitanteByTipoValorSpecification extends BaseSpecification<Limitante> {

  private final String name;

  public LimitanteByTipoValorSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Limitante> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Limitante_.tipovalor), "%"+this.name+"%");
  }
