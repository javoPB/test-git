...
public class NegativaperfilamientoByActividadProfesionalAnteriorSpecification extends BaseSpecification<Negativaperfilamiento> {

  private final String name;

  public NegativaperfilamientoByActividadProfesionalAnteriorSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Negativaperfilamiento> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Negativaperfilamiento_.actividadprofesionalanterior), "%"+this.name+"%");
  }
