...
public class NegativaperfilamientoByActividadRelacionadaInversionesSpecification extends BaseSpecification<Negativaperfilamiento> {

  private final String name;

  public NegativaperfilamientoByActividadRelacionadaInversionesSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Negativaperfilamiento> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Negativaperfilamiento_.actividadrelacionadainversiones), "%"+this.name+"%");
  }
