...
public class NegativaperfilamientoByFrecuenciaCertificadosCapSpecification extends BaseSpecification<Negativaperfilamiento> {

  private final String name;

  public NegativaperfilamientoByFrecuenciaCertificadosCapSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Negativaperfilamiento> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Negativaperfilamiento_.frecuenciacertificadoscap), "%"+this.name+"%");
  }
