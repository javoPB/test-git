...
public class NegativaperfilamientoByFrecuenciaSociedadesInvSpecification extends BaseSpecification<Negativaperfilamiento> {

  private final String name;

  public NegativaperfilamientoByFrecuenciaSociedadesInvSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Negativaperfilamiento> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Negativaperfilamiento_.frecuenciasociedadesinv), "%"+this.name+"%");
  }
