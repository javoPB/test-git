...
public class NegativaperfilamientoByFrecuenciaTrackersSpecification extends BaseSpecification<Negativaperfilamiento> {

  private final String name;

  public NegativaperfilamientoByFrecuenciaTrackersSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Negativaperfilamiento> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Negativaperfilamiento_.frecuenciatrackers), "%"+this.name+"%");
  }
