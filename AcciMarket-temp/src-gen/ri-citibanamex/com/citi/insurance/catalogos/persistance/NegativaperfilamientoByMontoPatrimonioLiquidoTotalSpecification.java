...
public class NegativaperfilamientoByMontoPatrimonioLiquidoTotalSpecification extends BaseSpecification<Negativaperfilamiento> {

  private final String name;

  public NegativaperfilamientoByMontoPatrimonioLiquidoTotalSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Negativaperfilamiento> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Negativaperfilamiento_.montopatrimonioliquidototal), "%"+this.name+"%");
  }
