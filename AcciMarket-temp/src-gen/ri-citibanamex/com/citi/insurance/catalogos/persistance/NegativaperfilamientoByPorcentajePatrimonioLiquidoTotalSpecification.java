...
public class NegativaperfilamientoByPorcentajePatrimonioLiquidoTotalSpecification extends BaseSpecification<Negativaperfilamiento> {

  private final String name;

  public NegativaperfilamientoByPorcentajePatrimonioLiquidoTotalSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Negativaperfilamiento> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Negativaperfilamiento_.porcentajepatrimonioliquidototal), "%"+this.name+"%");
  }
