...
public class NegativaperfilamientoByPorcentajeTotalPatrimonioSpecification extends BaseSpecification<Negativaperfilamiento> {

  private final String name;

  public NegativaperfilamientoByPorcentajeTotalPatrimonioSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Negativaperfilamiento> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Negativaperfilamiento_.porcentajetotalpatrimonio), "%"+this.name+"%");
  }
