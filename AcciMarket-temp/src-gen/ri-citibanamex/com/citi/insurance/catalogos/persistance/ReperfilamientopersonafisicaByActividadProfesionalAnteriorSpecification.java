...
public class ReperfilamientopersonafisicaByActividadProfesionalAnteriorSpecification extends BaseSpecification<Reperfilamientopersonafisica> {

  private final String name;

  public ReperfilamientopersonafisicaByActividadProfesionalAnteriorSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Reperfilamientopersonafisica> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Reperfilamientopersonafisica_.actividadprofesionalanterior), "%"+this.name+"%");
  }
