...
public class ReperfilamientopersonafisicaByActividadRelacionadaInversionesSpecification extends BaseSpecification<Reperfilamientopersonafisica> {

  private final String name;

  public ReperfilamientopersonafisicaByActividadRelacionadaInversionesSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Reperfilamientopersonafisica> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Reperfilamientopersonafisica_.actividadrelacionadainversiones), "%"+this.name+"%");
  }
