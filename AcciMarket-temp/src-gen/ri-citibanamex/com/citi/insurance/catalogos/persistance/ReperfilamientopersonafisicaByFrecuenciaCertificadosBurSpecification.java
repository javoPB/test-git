...
public class ReperfilamientopersonafisicaByFrecuenciaCertificadosBurSpecification extends BaseSpecification<Reperfilamientopersonafisica> {

  private final String name;

  public ReperfilamientopersonafisicaByFrecuenciaCertificadosBurSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Reperfilamientopersonafisica> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Reperfilamientopersonafisica_.frecuenciacertificadosbur), "%"+this.name+"%");
  }
