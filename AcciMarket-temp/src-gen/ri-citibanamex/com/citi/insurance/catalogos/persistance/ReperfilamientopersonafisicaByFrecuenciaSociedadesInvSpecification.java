...
public class ReperfilamientopersonafisicaByFrecuenciaSociedadesInvSpecification extends BaseSpecification<Reperfilamientopersonafisica> {

  private final String name;

  public ReperfilamientopersonafisicaByFrecuenciaSociedadesInvSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Reperfilamientopersonafisica> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Reperfilamientopersonafisica_.frecuenciasociedadesinv), "%"+this.name+"%");
  }
