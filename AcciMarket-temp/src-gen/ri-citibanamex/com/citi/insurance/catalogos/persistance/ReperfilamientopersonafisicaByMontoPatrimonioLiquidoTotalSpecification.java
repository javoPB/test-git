...
public class ReperfilamientopersonafisicaByMontoPatrimonioLiquidoTotalSpecification extends BaseSpecification<Reperfilamientopersonafisica> {

  private final String name;

  public ReperfilamientopersonafisicaByMontoPatrimonioLiquidoTotalSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Reperfilamientopersonafisica> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Reperfilamientopersonafisica_.montopatrimonioliquidototal), "%"+this.name+"%");
  }
