...
public class ReperfilamientopersonafisicaByPorcentajeLargoPlazoSpecification extends BaseSpecification<Reperfilamientopersonafisica> {

  private final String name;

  public ReperfilamientopersonafisicaByPorcentajeLargoPlazoSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Reperfilamientopersonafisica> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Reperfilamientopersonafisica_.porcentajelargoplazo), "%"+this.name+"%");
  }
