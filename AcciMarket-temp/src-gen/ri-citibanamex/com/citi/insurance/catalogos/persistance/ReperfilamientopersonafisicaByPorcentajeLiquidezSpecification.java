...
public class ReperfilamientopersonafisicaByPorcentajeLiquidezSpecification extends BaseSpecification<Reperfilamientopersonafisica> {

  private final String name;

  public ReperfilamientopersonafisicaByPorcentajeLiquidezSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Reperfilamientopersonafisica> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Reperfilamientopersonafisica_.porcentajeliquidez), "%"+this.name+"%");
  }
