...
public class ReperfilamientopersonafisicaByPorcentajePatrimonioLiquidoTotalSpecification extends BaseSpecification<Reperfilamientopersonafisica> {

  private final String name;

  public ReperfilamientopersonafisicaByPorcentajePatrimonioLiquidoTotalSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Reperfilamientopersonafisica> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Reperfilamientopersonafisica_.porcentajepatrimonioliquidototal), "%"+this.name+"%");
  }
