...
public class TitularcontratoByCalidadMigratoriaSpecification extends BaseSpecification<Titularcontrato> {

  private final String name;

  public TitularcontratoByCalidadMigratoriaSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Titularcontrato> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Titularcontrato_.calidadmigratoria), "%"+this.name+"%");
  }
