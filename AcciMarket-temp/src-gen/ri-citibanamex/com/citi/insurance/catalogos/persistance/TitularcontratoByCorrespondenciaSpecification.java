...
public class TitularcontratoByCorrespondenciaSpecification extends BaseSpecification<Titularcontrato> {

  private final String name;

  public TitularcontratoByCorrespondenciaSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Titularcontrato> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Titularcontrato_.correspondencia), "%"+this.name+"%");
  }
