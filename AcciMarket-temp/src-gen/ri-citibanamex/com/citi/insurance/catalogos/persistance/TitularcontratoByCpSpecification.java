...
public class TitularcontratoByCpSpecification extends BaseSpecification<Titularcontrato> {

  private final String name;

  public TitularcontratoByCpSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Titularcontrato> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Titularcontrato_.cp), "%"+this.name+"%");
  }
