...
public class TitularcontratoByDelMpoSpecification extends BaseSpecification<Titularcontrato> {

  private final String name;

  public TitularcontratoByDelMpoSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Titularcontrato> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Titularcontrato_.delmpo), "%"+this.name+"%");
  }
