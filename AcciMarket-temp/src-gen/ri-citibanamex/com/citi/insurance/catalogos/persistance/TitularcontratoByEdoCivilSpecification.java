...
public class TitularcontratoByEdoCivilSpecification extends BaseSpecification<Titularcontrato> {

  private final String name;

  public TitularcontratoByEdoCivilSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Titularcontrato> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Titularcontrato_.edocivil), "%"+this.name+"%");
  }
