...
public class TitularcontratoByEstadoSpecification extends BaseSpecification<Titularcontrato> {

  private final String name;

  public TitularcontratoByEstadoSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Titularcontrato> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Titularcontrato_.estado), "%"+this.name+"%");
  }
