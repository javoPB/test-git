...
public class TitularcontratoByMexExtrSpecification extends BaseSpecification<Titularcontrato> {

  private final String name;

  public TitularcontratoByMexExtrSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Titularcontrato> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Titularcontrato_.mexextr), "%"+this.name+"%");
  }
