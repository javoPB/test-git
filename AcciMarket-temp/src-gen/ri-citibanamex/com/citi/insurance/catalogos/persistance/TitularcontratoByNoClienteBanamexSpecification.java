...
public class TitularcontratoByNoClienteBanamexSpecification extends BaseSpecification<Titularcontrato> {

  private final String name;

  public TitularcontratoByNoClienteBanamexSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Titularcontrato> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Titularcontrato_.noclientebanamex), "%"+this.name+"%");
  }
