...
public class TitularcontratoByPaisResidenciaSpecification extends BaseSpecification<Titularcontrato> {

  private final String name;

  public TitularcontratoByPaisResidenciaSpecification(String name) {	  
	  this.name = name;
  }
  ...
  public Predicate toPredicate(Root<Titularcontrato> root, CriteriaQuery<?> cq,
          CriteriaBuilder cb) {
    return cb.like(root.get(Titularcontrato_.paisresidencia), "%"+this.name+"%");
  }
