	...
	Catalogo.prototype.forma = function(){
	    ...
	    var html = 
		  ...
		  +'							<div class="controls">'
		  +'								<input id="porcentaje" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="porcentaje">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
...
Catalogo.prototype.formaFiltros = function(){
    ...
    var html ='<div class="form">'
			...
			//+'		<fieldset class="fieldset"><legend>Beneficiarios</legend>'
			...
			+'								<label for="porcentaje" class="control-label">Porcentaje %</label>'
			+'								<div class="controls">'
			+'									<input id="porcentaje" class="form-control" data-type = "number" maxlength="0" data-length="0" name="porcentaje">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
...
, { header: "Porcentaje", field: "porcentaje" }
	...
	Catalogo.prototype.clear = function () {
		...
		if(
		   ...
		   || !_that.validator.isEmpty($('#porcentaje').val())
