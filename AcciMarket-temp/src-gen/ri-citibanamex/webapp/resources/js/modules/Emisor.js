	...
	Catalogo.prototype.forma = function(){
	    ...
	    var html = 
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="relacion" class="control-label">Relación</label>'
		  +'							<div class="controls">'
		  +'								<input id="relacion" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="relacion">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
...
Catalogo.prototype.formaFiltros = function(){
    ...
    var html ='<div class="form">'
			...
			//+'		<fieldset class="fieldset"><legend>Emisor</legend>'
			...
			+'								<label for="relacion" class="control-label">Relación</label>'
			+'								<div class="controls">'
			+'									<input id="relacion" class="form-control" data-type = "number" maxlength="0" data-length="0" name="relacion">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
...
, { header: "Relación", field: "relacion" }
...
, { header: "Relacion", field: "relacion" }
	...
	Catalogo.prototype.clear = function () {
		...
		if(
		   ...
		   || !_that.validator.isEmpty($('#relacion').val())
