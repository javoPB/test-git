	...
	Catalogo.prototype.forma = function(){
	    ...
	    var html = 
			...
			+'						<legend>Firma Autorizada</legend>'
		  ...
		  +'							<div class="controls">'
		  +'								<input id="apPaterno" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="apPaterno">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'							<div class="controls">'
		  +'								<input id="apMaterno" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="apMaterno">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="noEscr" class="control-label">No Escr</label>'
		  +'							<div class="controls">'
		  +'								<input id="noEscr" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="noEscr">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="noNot" class="control-label">No Not</label>'
		  +'							<div class="controls">'
		  +'								<input id="noNot" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="noNot">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
...
Catalogo.prototype.formaFiltros = function(){
    ...
    var html ='<div class="form">'
			...
			//+'		<fieldset class="fieldset"><legend>Firma Autorizada</legend>'
			...
			+'								<label for="apPaterno" class="control-label">Apellido Paterno</label>'
			+'								<div class="controls">'
			+'									<input id="apPaterno" class="form-control" data-type = "number" maxlength="0" data-length="0" name="apPaterno">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="apMaterno" class="control-label">Apellido Materno</label>'
			+'								<div class="controls">'
			+'									<input id="apMaterno" class="form-control" data-type = "number" maxlength="0" data-length="0" name="apMaterno">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="noEscr" class="control-label">No Escr</label>'
			+'								<div class="controls">'
			+'									<input id="noEscr" class="form-control" data-type = "number" maxlength="0" data-length="0" name="noEscr">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="noNot" class="control-label">No Not</label>'
			+'								<div class="controls">'
			+'									<input id="noNot" class="form-control" data-type = "number" maxlength="0" data-length="0" name="noNot">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
...
, { header: "Apellido Paterno", field: "apPaterno" }
	    	
, { header: "Apellido Materno", field: "apMaterno" }
	    	
, { header: "No Escr", field: "noEscr" }
	    	
, { header: "No Not", field: "noNot" }
	    	
	        ];
	    var i,j;
	    var html = "";
	    
	    html +="<h2>Firma Autorizada</h2>";
	...
	Catalogo.prototype.select = function( index ){
	 ...
	 // forma de clonar objetos
	    ...
	    $("#noEscr").prop('disabled', true);
	    $("#noNot").prop('disabled', true);
	};
	    ...
	    if(contError==0 && url!==null && datos.length>0){ //si no hay errores, se envía al controller
		    ...
		    for(var i=0; i<datos.length;i++){
		        ...
		        listBeans[i] = {
		            ...
		            ,  apPaterno : datos[i].ApPaterno
		            ,  apMaterno : datos[i].ApMaterno
		            ,  noEscr : datos[i].NoEscr
		            ,  noNot : datos[i].NoNot
		        }
...
, { header: "ApPaterno", field: "apPaterno" }
     	    	
, { header: "ApMaterno", field: "apMaterno" }
     	    	
, { header: "NoEscr", field: "noEscr" }
     	    	
, { header: "NoNot", field: "noNot" }
	...
	Catalogo.prototype.clear = function () {
		...
		if(
		   ...
		   || !_that.validator.isEmpty($('#apPaterno').val())
		   
		   || !_that.validator.isEmpty($('#apMaterno').val())
		   
		   || !_that.validator.isEmpty($('#noEscr').val())
		   
		   || !_that.validator.isEmpty($('#noNot').val())
