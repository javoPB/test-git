	...
	Catalogo.prototype.forma = function(){
	    ...
	    var html = 
		  ...
		  +'							<div class="controls">'
		  +'								<input id="operacion" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="operacion">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="tipo" class="control-label">Tipo Operación</label>'
		  +'							<div class="controls">'
		  +'								<input id="tipo" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="tipo">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="medLiq" class="control-label">Med. Liquidación</label>'
		  +'							<div class="controls">'
		  +'								<input id="medLiq" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="medLiq">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="subtipoPortafolio" class="control-label">Subtipo de Portafolio</label>'
		  +'							<div class="controls">'
		  +'								<input id="subtipoPortafolio" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="subtipoPortafolio">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'							<div class="controls">'
		  +'								<input id="saldo" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="saldo">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="contratoEgreso" class="control-label">Contrato</label>'
		  +'							<div class="controls">'
		  +'								<input id="contratoEgreso" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="contratoEgreso">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="digitoEgreso" class="control-label">Dígito</label>'
		  +'							<div class="controls">'
		  +'								<input id="digitoEgreso" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="digitoEgreso">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="saldoInicialEgreso" class="control-label">Saldo Inicial</label>'
		  +'							<div class="controls">'
		  +'								<input id="saldoInicialEgreso" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="saldoInicialEgreso">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="saldoCalculadoEgreso" class="control-label">Saldo Calculado</label>'
		  +'							<div class="controls">'
		  +'								<input id="saldoCalculadoEgreso" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="saldoCalculadoEgreso">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="benefEgreso" class="control-label">Benef.</label>'
		  +'							<div class="controls">'
		  +'								<input id="benefEgreso" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="benefEgreso">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="contratoIngreso" class="control-label">Contrato</label>'
		  +'							<div class="controls">'
		  +'								<input id="contratoIngreso" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="contratoIngreso">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="digitoIngreso" class="control-label">Dígito</label>'
		  +'							<div class="controls">'
		  +'								<input id="digitoIngreso" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="digitoIngreso">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="saldoInicialIngreso" class="control-label">Saldo Inicial</label>'
		  +'							<div class="controls">'
		  +'								<input id="saldoInicialIngreso" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="saldoInicialIngreso">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="saldoCalculadoIngreso" class="control-label">Saldo Calculado</label>'
		  +'							<div class="controls">'
		  +'								<input id="saldoCalculadoIngreso" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="saldoCalculadoIngreso">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="benefIngreso" class="control-label">Benef. --</label>'
		  +'							<div class="controls">'
		  +'								<input id="benefIngreso" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="benefIngreso">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="importeIngreso" class="control-label">Importe</label>'
		  +'							<div class="controls">'
		  +'								<input id="importeIngreso" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="importeIngreso">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
...
Catalogo.prototype.formaFiltros = function(){
    ...
    var html ='<div class="form">'
			...
			+'								<label for="operacion" class="control-label">Operación</label>'
			+'								<div class="controls">'
			+'									<input id="operacion" class="form-control" data-type = "number" maxlength="0" data-length="0" name="operacion">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="tipo" class="control-label">Tipo Operación</label>'
			+'								<div class="controls">'
			+'									<input id="tipo" class="form-control" data-type = "number" maxlength="0" data-length="0" name="tipo">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="medLiq" class="control-label">Med. Liquidación</label>'
			+'								<div class="controls">'
			+'									<input id="medLiq" class="form-control" data-type = "number" maxlength="0" data-length="0" name="medLiq">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="subtipoPortafolio" class="control-label">Subtipo de Portafolio</label>'
			+'								<div class="controls">'
			+'									<input id="subtipoPortafolio" class="form-control" data-type = "number" maxlength="0" data-length="0" name="subtipoPortafolio">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="saldo" class="control-label">Saldo</label>'
			+'								<div class="controls">'
			+'									<input id="saldo" class="form-control" data-type = "number" maxlength="0" data-length="0" name="saldo">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="contratoEgreso" class="control-label">Contrato</label>'
			+'								<div class="controls">'
			+'									<input id="contratoEgreso" class="form-control" data-type = "number" maxlength="0" data-length="0" name="contratoEgreso">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="digitoEgreso" class="control-label">Dígito</label>'
			+'								<div class="controls">'
			+'									<input id="digitoEgreso" class="form-control" data-type = "number" maxlength="0" data-length="0" name="digitoEgreso">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="saldoInicialEgreso" class="control-label">Saldo Inicial</label>'
			+'								<div class="controls">'
			+'									<input id="saldoInicialEgreso" class="form-control" data-type = "number" maxlength="0" data-length="0" name="saldoInicialEgreso">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="saldoCalculadoEgreso" class="control-label">Saldo Calculado</label>'
			+'								<div class="controls">'
			+'									<input id="saldoCalculadoEgreso" class="form-control" data-type = "number" maxlength="0" data-length="0" name="saldoCalculadoEgreso">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="benefEgreso" class="control-label">Benef.</label>'
			+'								<div class="controls">'
			+'									<input id="benefEgreso" class="form-control" data-type = "number" maxlength="0" data-length="0" name="benefEgreso">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="contratoIngreso" class="control-label">Contrato</label>'
			+'								<div class="controls">'
			+'									<input id="contratoIngreso" class="form-control" data-type = "number" maxlength="0" data-length="0" name="contratoIngreso">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="digitoIngreso" class="control-label">Dígito</label>'
			+'								<div class="controls">'
			+'									<input id="digitoIngreso" class="form-control" data-type = "number" maxlength="0" data-length="0" name="digitoIngreso">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="saldoInicialIngreso" class="control-label">Saldo Inicial</label>'
			+'								<div class="controls">'
			+'									<input id="saldoInicialIngreso" class="form-control" data-type = "number" maxlength="0" data-length="0" name="saldoInicialIngreso">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="saldoCalculadoIngreso" class="control-label">Saldo Calculado</label>'
			+'								<div class="controls">'
			+'									<input id="saldoCalculadoIngreso" class="form-control" data-type = "number" maxlength="0" data-length="0" name="saldoCalculadoIngreso">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="benefIngreso" class="control-label">Benef. --</label>'
			+'								<div class="controls">'
			+'									<input id="benefIngreso" class="form-control" data-type = "number" maxlength="0" data-length="0" name="benefIngreso">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="importeIngreso" class="control-label">Importe</label>'
			+'								<div class="controls">'
			+'									<input id="importeIngreso" class="form-control" data-type = "number" maxlength="0" data-length="0" name="importeIngreso">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
...
, { header: "Operación", field: "operacion" }
	    	
, { header: "Tipo Operación", field: "tipo" }
	    	
, { header: "Med. Liquidación", field: "medLiq" }
	    	
, { header: "Contrato", field: "contrato" }
	    	
, { header: "Subtipo de Portafolio", field: "subtipoPortafolio" }
...
, { header: "Contrato", field: "contratoEgreso" }
	    	
, { header: "Dígito", field: "digitoEgreso" }
	    	
, { header: "Saldo Inicial", field: "saldoInicialEgreso" }
	    	
, { header: "Saldo Calculado", field: "saldoCalculadoEgreso" }
	    	
, { header: "Benef.", field: "benefEgreso" }
	    	
, { header: "Contrato", field: "contratoIngreso" }
	    	
, { header: "Dígito", field: "digitoIngreso" }
	    	
, { header: "Saldo Inicial", field: "saldoInicialIngreso" }
	    	
, { header: "Saldo Calculado", field: "saldoCalculadoIngreso" }
	    	
, { header: "Benef. --", field: "benefIngreso" }
	    	
, { header: "Importe", field: "importeIngreso" }
	...
	Catalogo.prototype.select = function( index ){
	 ...
	 // forma de clonar objetos
	    ...
	    $("#operacion").prop('disabled', true);
	    $("#tipo").prop('disabled', true);
	    $("#medLiq").prop('disabled', true);
	    $("#contrato").prop('disabled', true);
	    $("#subtipoPortafolio").prop('disabled', true);
	    $("#digito").prop('disabled', true);
	    $("#titular").prop('disabled', true);
	    $("#saldo").prop('disabled', true);
	    $("#contratoEgreso").prop('disabled', true);
	    $("#digitoEgreso").prop('disabled', true);
	    $("#saldoInicialEgreso").prop('disabled', true);
	    $("#saldoCalculadoEgreso").prop('disabled', true);
	    $("#benefEgreso").prop('disabled', true);
	    $("#contratoIngreso").prop('disabled', true);
	    $("#digitoIngreso").prop('disabled', true);
	    $("#saldoInicialIngreso").prop('disabled', true);
	    $("#saldoCalculadoIngreso").prop('disabled', true);
	    $("#benefIngreso").prop('disabled', true);
	    $("#importeIngreso").prop('disabled', true);
	};
	    ...
	    if(contError==0 && url!==null && datos.length>0){ //si no hay errores, se envía al controller
		    ...
		    for(var i=0; i<datos.length;i++){
		        ...
		        listBeans[i] = {
		            ...
		            ,  tipo : datos[i].Tipo
		            ,  medLiq : datos[i].MedLiq
		            ,  contrato : datos[i].Contrato
		            ,  subtipoPortafolio : datos[i].SubtipoPortafolio
		            ,  digito : datos[i].Digito
		            ,  titular : datos[i].Titular
		            ,  saldo : datos[i].Saldo
		            ,  contratoEgreso : datos[i].ContratoEgreso
		            ,  digitoEgreso : datos[i].DigitoEgreso
		            ,  saldoInicialEgreso : datos[i].SaldoInicialEgreso
		            ,  saldoCalculadoEgreso : datos[i].SaldoCalculadoEgreso
		            ,  benefEgreso : datos[i].BenefEgreso
		            ,  contratoIngreso : datos[i].ContratoIngreso
		            ,  digitoIngreso : datos[i].DigitoIngreso
		            ,  saldoInicialIngreso : datos[i].SaldoInicialIngreso
		            ,  saldoCalculadoIngreso : datos[i].SaldoCalculadoIngreso
		            ,  benefIngreso : datos[i].BenefIngreso
		            ,  importeIngreso : datos[i].ImporteIngreso
		        }
...
, { header: "Operacion", field: "operacion" }
     	    	
, { header: "Tipo", field: "tipo" }
     	    	
, { header: "MedLiq", field: "medLiq" }
     	    	
, { header: "Contrato", field: "contrato" }
     	    	
, { header: "SubtipoPortafolio", field: "subtipoPortafolio" }
...
, { header: "ContratoEgreso", field: "contratoEgreso" }
     	    	
, { header: "DigitoEgreso", field: "digitoEgreso" }
     	    	
, { header: "SaldoInicialEgreso", field: "saldoInicialEgreso" }
     	    	
, { header: "SaldoCalculadoEgreso", field: "saldoCalculadoEgreso" }
     	    	
, { header: "BenefEgreso", field: "benefEgreso" }
     	    	
, { header: "ContratoIngreso", field: "contratoIngreso" }
     	    	
, { header: "DigitoIngreso", field: "digitoIngreso" }
     	    	
, { header: "SaldoInicialIngreso", field: "saldoInicialIngreso" }
     	    	
, { header: "SaldoCalculadoIngreso", field: "saldoCalculadoIngreso" }
     	    	
, { header: "BenefIngreso", field: "benefIngreso" }
     	    	
, { header: "ImporteIngreso", field: "importeIngreso" }
	...
	Catalogo.prototype.clear = function () {
		...
		if(
		   ...
		   || !_that.validator.isEmpty($('#operacion').val())
		   
		   || !_that.validator.isEmpty($('#tipo').val())
		   
		   || !_that.validator.isEmpty($('#medLiq').val())
		   
		   || !_that.validator.isEmpty($('#contrato').val())
		   
		   || !_that.validator.isEmpty($('#subtipoPortafolio').val())
		   
		   || !_that.validator.isEmpty($('#digito').val())
		   
		   || !_that.validator.isEmpty($('#titular').val())
		   
		   || !_that.validator.isEmpty($('#saldo').val())
		   
		   || !_that.validator.isEmpty($('#contratoEgreso').val())
		   
		   || !_that.validator.isEmpty($('#digitoEgreso').val())
		   
		   || !_that.validator.isEmpty($('#saldoInicialEgreso').val())
		   
		   || !_that.validator.isEmpty($('#saldoCalculadoEgreso').val())
		   
		   || !_that.validator.isEmpty($('#benefEgreso').val())
		   
		   || !_that.validator.isEmpty($('#contratoIngreso').val())
		   
		   || !_that.validator.isEmpty($('#digitoIngreso').val())
		   
		   || !_that.validator.isEmpty($('#saldoInicialIngreso').val())
		   
		   || !_that.validator.isEmpty($('#saldoCalculadoIngreso').val())
		   
		   || !_that.validator.isEmpty($('#benefIngreso').val())
		   
		   || !_that.validator.isEmpty($('#importeIngreso').val())
			...
			$('#medliq').val('');
			$('#contrato').val('');
			$('#subtipoPortafolio').val('');
			$('#digito').val('');
			$('#titular').val('');
			$('#saldo').val('');
			$('#contratoEgreso').val('');
			$('#digitoEgreso').val('');
			$('#saldoInicialEgreso').val('');
			$('#saldoCalculadoEgreso').val('');
			$('#benefegreso').val('');
			$('#contratoIngreso').val('');
			$('#digitoIngreso').val('');
			$('#saldoInicialIngreso').val('');
			$('#saldoCalculadoIngreso').val('');
			$('#benefingreso').val('');
			$('#importeIngreso').val('');
			_that.init();
		}
