	...
	Catalogo.prototype.forma = function(){
	    ...
	    var html = 
			...
			+'						<legend>Negativa de Perfilamiento</legend>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="personaPerfilar" class="control-label">Seleccione la persona que desea perfilar</label>'
		  +'							<div class="controls">'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="expTitulosOpc" class="control-label">2.6 Títulos Opcionales (Warrant)</label>'
		  +'							<div class="controls">'
		  +'								<input id="expTitulosOpc" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="expTitulosOpc">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="frecuenciaTitulosOpc" class="control-label">Frecuencia</label>'
		  +'							<div class="controls">'
		  +'								<input id="frecuenciaTitulosOpc" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="frecuenciaTitulosOpc">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="plazoTitulosOpc" class="control-label">Plazo</label>'
		  +'							<div class="controls">'
		  +'								<input id="plazoTitulosOpc" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="plazoTitulosOpc">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="volumenTitulosOpc" class="control-label">Volumen</label>'
		  +'							<div class="controls">'
		  +'								<input id="volumenTitulosOpc" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="volumenTitulosOpc">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="expAcciones" class="control-label">2.7 Acciones</label>'
		  +'							<div class="controls">'
		  +'								<input id="expAcciones" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="expAcciones">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="frecuenciaAcciones" class="control-label">Frecuencia</label>'
		  +'							<div class="controls">'
		  +'								<input id="frecuenciaAcciones" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="frecuenciaAcciones">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="plazoAcciones" class="control-label">Plazo</label>'
		  +'							<div class="controls">'
		  +'								<input id="plazoAcciones" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="plazoAcciones">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="volumenAcciones" class="control-label">Volumen</label>'
		  +'							<div class="controls">'
		  +'								<input id="volumenAcciones" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="volumenAcciones">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="expValoresExt" class="control-label">2.8 Valores Extranjeros</label>'
		  +'							<div class="controls">'
		  +'								<input id="expValoresExt" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="expValoresExt">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="frecuenciaValoresExt" class="control-label">Frecuencia</label>'
		  +'							<div class="controls">'
		  +'								<input id="frecuenciaValoresExt" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="frecuenciaValoresExt">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="plazoValoresExt" class="control-label">Plazo</label>'
		  +'							<div class="controls">'
		  +'								<input id="plazoValoresExt" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="plazoValoresExt">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="volumenValoresExt" class="control-label">Volumen</label>'
		  +'							<div class="controls">'
		  +'								<input id="volumenValoresExt" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="volumenValoresExt">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="expTrackers" class="control-label">2.9 Trackers TRACs o ETFs</label>'
		  +'							<div class="controls">'
		  +'								<input id="expTrackers" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="expTrackers">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="frecuenciaTrackers" class="control-label">Frecuencia</label>'
		  +'							<div class="controls">'
		  +'								<input id="frecuenciaTrackers" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="frecuenciaTrackers">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="plazoTrackers" class="control-label">Plazo</label>'
		  +'							<div class="controls">'
		  +'								<input id="plazoTrackers" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="plazoTrackers">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="volumenTrackers" class="control-label">Volumen</label>'
		  +'							<div class="controls">'
		  +'								<input id="volumenTrackers" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="volumenTrackers">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="expCertificadosCap" class="control-label">2.5 Certificados de Capital de Desarrollo (CKDs)</label>'
		  +'							<div class="controls">'
		  +'								<input id="expCertificadosCap" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="expCertificadosCap">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="frecuenciaCertificadosCap" class="control-label">Frecuencia</label>'
		  +'							<div class="controls">'
		  +'								<input id="frecuenciaCertificadosCap" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="frecuenciaCertificadosCap">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="plazoCertificadosCap" class="control-label">Plazo</label>'
		  +'							<div class="controls">'
		  +'								<input id="plazoCertificadosCap" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="plazoCertificadosCap">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="volumenCertificadosCap" class="control-label">Volumen</label>'
		  +'							<div class="controls">'
		  +'								<input id="volumenCertificadosCap" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="volumenCertificadosCap">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="propositoInversion" class="control-label">Seleccionar el Propósito de Inversión del Cliente (Estrategia)</label>'
		  +'							<div class="controls">'
		  +'								<input id="propositoInversion" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="propositoInversion">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="toleranciaRiesgo" class="control-label">Seleccionar la Torelancia al Riesgo del Cliente</label>'
		  +'							<div class="controls">'
		  +'								<input id="toleranciaRiesgo" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="toleranciaRiesgo">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="horizonteInversion" class="control-label">Seleccionar el Horizonte de Inversión del Cliente</label>'
		  +'							<div class="controls">'
		  +'								<input id="horizonteInversion" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="horizonteInversion">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
		  ...
		  +'					<div class="column">'
		  +'						<div class="control-group">'
		  +'							<label for="inconsistencias" class="control-label">Inconsistencias</label>'
		  +'							<div class="controls">'
		  +'								<input id="inconsistencias" class="form-control" data-type = "varchar" maxlength="0" data-length="0" name="inconsistencias">'
		  +'								<br><span class ="textError" style="display: none;">Error</span>'
		  +'							</div>'
		  +'						</div>'
		  +'					</div>'
...
Catalogo.prototype.formaFiltros = function(){
    ...
    var html ='<div class="form">'
			...
			//+'		<fieldset class="fieldset"><legend>Negativa de Perfilamiento</legend>'
			...
			+'								<label for="expTitulosOpc" class="control-label">2.6 Títulos Opcionales (Warrant)</label>'
			+'								<div class="controls">'
			+'									<input id="expTitulosOpc" class="form-control" data-type = "number" maxlength="0" data-length="0" name="expTitulosOpc">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="frecuenciaTitulosOpc" class="control-label">Frecuencia</label>'
			+'								<div class="controls">'
			+'									<input id="frecuenciaTitulosOpc" class="form-control" data-type = "number" maxlength="0" data-length="0" name="frecuenciaTitulosOpc">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="plazoTitulosOpc" class="control-label">Plazo</label>'
			+'								<div class="controls">'
			+'									<input id="plazoTitulosOpc" class="form-control" data-type = "number" maxlength="0" data-length="0" name="plazoTitulosOpc">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="volumenTitulosOpc" class="control-label">Volumen</label>'
			+'								<div class="controls">'
			+'									<input id="volumenTitulosOpc" class="form-control" data-type = "number" maxlength="0" data-length="0" name="volumenTitulosOpc">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="expAcciones" class="control-label">2.7 Acciones</label>'
			+'								<div class="controls">'
			+'									<input id="expAcciones" class="form-control" data-type = "number" maxlength="0" data-length="0" name="expAcciones">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="frecuenciaAcciones" class="control-label">Frecuencia</label>'
			+'								<div class="controls">'
			+'									<input id="frecuenciaAcciones" class="form-control" data-type = "number" maxlength="0" data-length="0" name="frecuenciaAcciones">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="plazoAcciones" class="control-label">Plazo</label>'
			+'								<div class="controls">'
			+'									<input id="plazoAcciones" class="form-control" data-type = "number" maxlength="0" data-length="0" name="plazoAcciones">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="volumenAcciones" class="control-label">Volumen</label>'
			+'								<div class="controls">'
			+'									<input id="volumenAcciones" class="form-control" data-type = "number" maxlength="0" data-length="0" name="volumenAcciones">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="expValoresExt" class="control-label">2.8 Valores Extranjeros</label>'
			+'								<div class="controls">'
			+'									<input id="expValoresExt" class="form-control" data-type = "number" maxlength="0" data-length="0" name="expValoresExt">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="frecuenciaValoresExt" class="control-label">Frecuencia</label>'
			+'								<div class="controls">'
			+'									<input id="frecuenciaValoresExt" class="form-control" data-type = "number" maxlength="0" data-length="0" name="frecuenciaValoresExt">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="plazoValoresExt" class="control-label">Plazo</label>'
			+'								<div class="controls">'
			+'									<input id="plazoValoresExt" class="form-control" data-type = "number" maxlength="0" data-length="0" name="plazoValoresExt">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="volumenValoresExt" class="control-label">Volumen</label>'
			+'								<div class="controls">'
			+'									<input id="volumenValoresExt" class="form-control" data-type = "number" maxlength="0" data-length="0" name="volumenValoresExt">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="expTrackers" class="control-label">2.9 Trackers TRACs o ETFs</label>'
			+'								<div class="controls">'
			+'									<input id="expTrackers" class="form-control" data-type = "number" maxlength="0" data-length="0" name="expTrackers">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="frecuenciaTrackers" class="control-label">Frecuencia</label>'
			+'								<div class="controls">'
			+'									<input id="frecuenciaTrackers" class="form-control" data-type = "number" maxlength="0" data-length="0" name="frecuenciaTrackers">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="plazoTrackers" class="control-label">Plazo</label>'
			+'								<div class="controls">'
			+'									<input id="plazoTrackers" class="form-control" data-type = "number" maxlength="0" data-length="0" name="plazoTrackers">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="volumenTrackers" class="control-label">Volumen</label>'
			+'								<div class="controls">'
			+'									<input id="volumenTrackers" class="form-control" data-type = "number" maxlength="0" data-length="0" name="volumenTrackers">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="expCertificadosCap" class="control-label">2.5 Certificados de Capital de Desarrollo (CKDs)</label>'
			+'								<div class="controls">'
			+'									<input id="expCertificadosCap" class="form-control" data-type = "number" maxlength="0" data-length="0" name="expCertificadosCap">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="frecuenciaCertificadosCap" class="control-label">Frecuencia</label>'
			+'								<div class="controls">'
			+'									<input id="frecuenciaCertificadosCap" class="form-control" data-type = "number" maxlength="0" data-length="0" name="frecuenciaCertificadosCap">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="plazoCertificadosCap" class="control-label">Plazo</label>'
			+'								<div class="controls">'
			+'									<input id="plazoCertificadosCap" class="form-control" data-type = "number" maxlength="0" data-length="0" name="plazoCertificadosCap">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="volumenCertificadosCap" class="control-label">Volumen</label>'
			+'								<div class="controls">'
			+'									<input id="volumenCertificadosCap" class="form-control" data-type = "number" maxlength="0" data-length="0" name="volumenCertificadosCap">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="propositoInversion" class="control-label">Seleccionar el Propósito de Inversión del Cliente (Estrategia)</label>'
			+'								<div class="controls">'
			+'									<input id="propositoInversion" class="form-control" data-type = "number" maxlength="0" data-length="0" name="propositoInversion">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="toleranciaRiesgo" class="control-label">Seleccionar la Torelancia al Riesgo del Cliente</label>'
			+'								<div class="controls">'
			+'									<input id="toleranciaRiesgo" class="form-control" data-type = "number" maxlength="0" data-length="0" name="toleranciaRiesgo">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="horizonteInversion" class="control-label">Seleccionar el Horizonte de Inversión del Cliente</label>'
			+'								<div class="controls">'
			+'									<input id="horizonteInversion" class="form-control" data-type = "number" maxlength="0" data-length="0" name="horizonteInversion">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
			...
			+'								<label for="inconsistencias" class="control-label">Inconsistencias</label>'
			+'								<div class="controls">'
			+'									<input id="inconsistencias" class="form-control" data-type = "number" maxlength="0" data-length="0" name="inconsistencias">'
			+'									<br><span class ="textError" style="display: none;">Error</span>'
			+'								</div>'
			+'							</div>'
			+'						</div>'
...
, { header: "Seleccione la persona que desea perfilar", field: "personaPerfilar" }
...
, { header: "2.6 Títulos Opcionales (Warrant)", field: "expTitulosOpc" }
	    	
, { header: "Frecuencia", field: "frecuenciaTitulosOpc" }
	    	
, { header: "Plazo", field: "plazoTitulosOpc" }
	    	
, { header: "Volumen", field: "volumenTitulosOpc" }
	    	
, { header: "2.7 Acciones", field: "expAcciones" }
	    	
, { header: "Frecuencia", field: "frecuenciaAcciones" }
	    	
, { header: "Plazo", field: "plazoAcciones" }
	    	
, { header: "Volumen", field: "volumenAcciones" }
	    	
, { header: "2.8 Valores Extranjeros", field: "expValoresExt" }
	    	
, { header: "Frecuencia", field: "frecuenciaValoresExt" }
	    	
, { header: "Plazo", field: "plazoValoresExt" }
	    	
, { header: "Volumen", field: "volumenValoresExt" }
	    	
, { header: "2.9 Trackers TRACs o ETFs", field: "expTrackers" }
	    	
, { header: "Frecuencia", field: "frecuenciaTrackers" }
	    	
, { header: "Plazo", field: "plazoTrackers" }
	    	
, { header: "Volumen", field: "volumenTrackers" }
	    	
, { header: "2.5 Certificados de Capital de Desarrollo (CKDs)", field: "expCertificadosCap" }
	    	
, { header: "Frecuencia", field: "frecuenciaCertificadosCap" }
	    	
, { header: "Plazo", field: "plazoCertificadosCap" }
	    	
, { header: "Volumen", field: "volumenCertificadosCap" }
	    	
, { header: "Seleccionar el Propósito de Inversión del Cliente (Estrategia)", field: "propositoInversion" }
	    	
, { header: "Seleccionar la Torelancia al Riesgo del Cliente", field: "toleranciaRiesgo" }
	    	
, { header: "Seleccionar el Horizonte de Inversión del Cliente", field: "horizonteInversion" }
...
, { header: "Inconsistencias", field: "inconsistencias" }
	    	
	        ];
	    var i,j;
	    var html = "";
	    
	    html +="<h2>Negativa de Perfilamiento</h2>";
	...
	Catalogo.prototype.select = function( index ){
	 ...
	 // forma de clonar objetos
	    ...
	    $("#expTitulosOpc").prop('disabled', true);
	    $("#frecuenciaTitulosOpc").prop('disabled', true);
	    $("#plazoTitulosOpc").prop('disabled', true);
	    $("#volumenTitulosOpc").prop('disabled', true);
	    $("#expAcciones").prop('disabled', true);
	    $("#frecuenciaAcciones").prop('disabled', true);
	    $("#plazoAcciones").prop('disabled', true);
	    $("#volumenAcciones").prop('disabled', true);
	    $("#expValoresExt").prop('disabled', true);
	    $("#frecuenciaValoresExt").prop('disabled', true);
	    $("#plazoValoresExt").prop('disabled', true);
	    $("#volumenValoresExt").prop('disabled', true);
	    $("#expTrackers").prop('disabled', true);
	    $("#frecuenciaTrackers").prop('disabled', true);
	    $("#plazoTrackers").prop('disabled', true);
	    $("#volumenTrackers").prop('disabled', true);
	    $("#expCertificadosCap").prop('disabled', true);
	    $("#frecuenciaCertificadosCap").prop('disabled', true);
	    $("#plazoCertificadosCap").prop('disabled', true);
	    $("#volumenCertificadosCap").prop('disabled', true);
	    $("#propositoInversion").prop('disabled', true);
	    $("#toleranciaRiesgo").prop('disabled', true);
	    $("#horizonteInversion").prop('disabled', true);
	    ...
	    $("#inconsistencias").prop('disabled', true);
	};
...
case 'ExpTitulosOpc':
	...
	if(!error)
		error =_that.validator.validateLengthFile(campo, 0);
break;		
case 'FrecuenciaTitulosOpc':
	/*****CAMPO x***/
	error =_that.validator.alphaNumericFile(campo);
	if(!error)
		error =_that.validator.validateLengthFile(campo, 0);
break;		
case 'PlazoTitulosOpc':
	/*****CAMPO x***/
	error =_that.validator.alphaNumericFile(campo);
	if(!error)
		error =_that.validator.validateLengthFile(campo, 0);
break;		
case 'VolumenTitulosOpc':
	/*****CAMPO x***/
	error =_that.validator.alphaNumericFile(campo);
	if(!error)
		error =_that.validator.validateLengthFile(campo, 0);
...
case 'ExpValoresExt':
	...
	if(!error)
		error =_that.validator.validateLengthFile(campo, 0);
break;		
case 'FrecuenciaValoresExt':
	/*****CAMPO x***/
	error =_that.validator.alphaNumericFile(campo);
	if(!error)
		error =_that.validator.validateLengthFile(campo, 0);
break;		
case 'PlazoValoresExt':
	/*****CAMPO x***/
	error =_that.validator.alphaNumericFile(campo);
	if(!error)
		error =_that.validator.validateLengthFile(campo, 0);
break;		
case 'VolumenValoresExt':
	/*****CAMPO x***/
	error =_that.validator.alphaNumericFile(campo);
	if(!error)
		error =_that.validator.validateLengthFile(campo, 0);
...
case 'PlazoTrackers':
	...
	if(!error)
		error =_that.validator.validateLengthFile(campo, 0);
break;		
case 'VolumenTrackers':
	/*****CAMPO x***/
	error =_that.validator.alphaNumericFile(campo);
	if(!error)
		error =_that.validator.validateLengthFile(campo, 0);
break;		
case 'ExpCertificadosCap':
	/*****CAMPO x***/
	error =_that.validator.alphaNumericFile(campo);
	if(!error)
		error =_that.validator.validateLengthFile(campo, 0);
break;		
case 'FrecuenciaCertificadosCap':
	/*****CAMPO x***/
	error =_that.validator.alphaNumericFile(campo);
	if(!error)
		error =_that.validator.validateLengthFile(campo, 0);
break;		
case 'PlazoCertificadosCap':
	/*****CAMPO x***/
	error =_that.validator.alphaNumericFile(campo);
	if(!error)
		error =_that.validator.validateLengthFile(campo, 0);
break;		
case 'VolumenCertificadosCap':
	/*****CAMPO x***/
	error =_that.validator.alphaNumericFile(campo);
	if(!error)
		error =_that.validator.validateLengthFile(campo, 0);
break;		
case 'PropositoInversion':
	/*****CAMPO x***/
	error =_that.validator.alphaNumericFile(campo);
	if(!error)
		error =_that.validator.validateLengthFile(campo, 0);
break;		
case 'ToleranciaRiesgo':
	/*****CAMPO x***/
	error =_that.validator.alphaNumericFile(campo);
	if(!error)
		error =_that.validator.validateLengthFile(campo, 0);
	    ...
	    if(contError==0 && url!==null && datos.length>0){ //si no hay errores, se envía al controller
		    ...
		    for(var i=0; i<datos.length;i++){
		        ...
		        listBeans[i] = {
		            ...
		            ,  expTitulosOpc : datos[i].ExpTitulosOpc
		            ,  frecuenciaTitulosOpc : datos[i].FrecuenciaTitulosOpc
		            ,  plazoTitulosOpc : datos[i].PlazoTitulosOpc
		            ,  volumenTitulosOpc : datos[i].VolumenTitulosOpc
		            ,  expAcciones : datos[i].ExpAcciones
		            ,  frecuenciaAcciones : datos[i].FrecuenciaAcciones
		            ,  plazoAcciones : datos[i].PlazoAcciones
		            ,  volumenAcciones : datos[i].VolumenAcciones
		            ,  expValoresExt : datos[i].ExpValoresExt
		            ,  frecuenciaValoresExt : datos[i].FrecuenciaValoresExt
		            ,  plazoValoresExt : datos[i].PlazoValoresExt
		            ,  volumenValoresExt : datos[i].VolumenValoresExt
		            ,  expTrackers : datos[i].ExpTrackers
		            ,  frecuenciaTrackers : datos[i].FrecuenciaTrackers
		            ,  plazoTrackers : datos[i].PlazoTrackers
		            ,  volumenTrackers : datos[i].VolumenTrackers
		            ,  expCertificadosCap : datos[i].ExpCertificadosCap
		            ,  frecuenciaCertificadosCap : datos[i].FrecuenciaCertificadosCap
		            ,  plazoCertificadosCap : datos[i].PlazoCertificadosCap
		            ,  volumenCertificadosCap : datos[i].VolumenCertificadosCap
		            ,  propositoInversion : datos[i].PropositoInversion
		            ,  toleranciaRiesgo : datos[i].ToleranciaRiesgo
		            ,  horizonteInversion : datos[i].HorizonteInversion
		            ...
		            ,  inconsistencias : datos[i].Inconsistencias
		        }
...
"Contrato"
	    	...
	    	, "VolumenTrackers"
	    	, "ExpCertificadosCap"
	    	, "FrecuenciaCertificadosCap"
	    	, "PlazoCertificadosCap"
	    	, "VolumenCertificadosCap"
	    	, "PropositoInversion"
	    	, "ToleranciaRiesgo"
	    	, "HorizonteInversion"
	    	, "TieneLimitante"
	  ...
	  var url = this.LOAD;
	  var name = "NegativaPerfilamiento"; 
	  var _that = this;
	  if (url !== null) {
	    $.ajax({
	      url: url,
...
, { header: "ExpTitulosOpc", field: "expTitulosOpc" }
     	    	
, { header: "FrecuenciaTitulosOpc", field: "frecuenciaTitulosOpc" }
     	    	
, { header: "PlazoTitulosOpc", field: "plazoTitulosOpc" }
     	    	
, { header: "VolumenTitulosOpc", field: "volumenTitulosOpc" }
     	    	
, { header: "ExpAcciones", field: "expAcciones" }
     	    	
, { header: "FrecuenciaAcciones", field: "frecuenciaAcciones" }
     	    	
, { header: "PlazoAcciones", field: "plazoAcciones" }
     	    	
, { header: "VolumenAcciones", field: "volumenAcciones" }
     	    	
, { header: "ExpValoresExt", field: "expValoresExt" }
     	    	
, { header: "FrecuenciaValoresExt", field: "frecuenciaValoresExt" }
     	    	
, { header: "PlazoValoresExt", field: "plazoValoresExt" }
     	    	
, { header: "VolumenValoresExt", field: "volumenValoresExt" }
     	    	
, { header: "ExpTrackers", field: "expTrackers" }
     	    	
, { header: "FrecuenciaTrackers", field: "frecuenciaTrackers" }
     	    	
, { header: "PlazoTrackers", field: "plazoTrackers" }
     	    	
, { header: "VolumenTrackers", field: "volumenTrackers" }
     	    	
, { header: "ExpCertificadosCap", field: "expCertificadosCap" }
     	    	
, { header: "FrecuenciaCertificadosCap", field: "frecuenciaCertificadosCap" }
     	    	
, { header: "PlazoCertificadosCap", field: "plazoCertificadosCap" }
     	    	
, { header: "VolumenCertificadosCap", field: "volumenCertificadosCap" }
     	    	
, { header: "PropositoInversion", field: "propositoInversion" }
     	    	
, { header: "ToleranciaRiesgo", field: "toleranciaRiesgo" }
     	    	
, { header: "HorizonteInversion", field: "horizonteInversion" }
...
, { header: "Inconsistencias", field: "inconsistencias" }
	...
	Catalogo.prototype.clear = function () {
		...
		if(
		   ...
		   || !_that.validator.isEmpty($('#expTitulosOpc').val())
		   
		   || !_that.validator.isEmpty($('#frecuenciaTitulosOpc').val())
		   
		   || !_that.validator.isEmpty($('#plazoTitulosOpc').val())
		   
		   || !_that.validator.isEmpty($('#volumenTitulosOpc').val())
		   
		   || !_that.validator.isEmpty($('#expAcciones').val())
		   
		   || !_that.validator.isEmpty($('#frecuenciaAcciones').val())
		   
		   || !_that.validator.isEmpty($('#plazoAcciones').val())
		   
		   || !_that.validator.isEmpty($('#volumenAcciones').val())
		   
		   || !_that.validator.isEmpty($('#expValoresExt').val())
		   
		   || !_that.validator.isEmpty($('#frecuenciaValoresExt').val())
		   
		   || !_that.validator.isEmpty($('#plazoValoresExt').val())
		   
		   || !_that.validator.isEmpty($('#volumenValoresExt').val())
		   
		   || !_that.validator.isEmpty($('#expTrackers').val())
		   
		   || !_that.validator.isEmpty($('#frecuenciaTrackers').val())
		   
		   || !_that.validator.isEmpty($('#plazoTrackers').val())
		   
		   || !_that.validator.isEmpty($('#volumenTrackers').val())
		   
		   || !_that.validator.isEmpty($('#expCertificadosCap').val())
		   
		   || !_that.validator.isEmpty($('#frecuenciaCertificadosCap').val())
		   
		   || !_that.validator.isEmpty($('#plazoCertificadosCap').val())
		   
		   || !_that.validator.isEmpty($('#volumenCertificadosCap').val())
		   
		   || !_that.validator.isEmpty($('#propositoInversion').val())
		   
		   || !_that.validator.isEmpty($('#toleranciaRiesgo').val())
		   
		   || !_that.validator.isEmpty($('#horizonteInversion').val())
		   ...
		   || !_that.validator.isEmpty($('#inconsistencias').val())
			...
			$('#exptitulosopc').val('');
			$('#frecuenciatitulosopc').val('');
			$('#plazotitulosopc').val('');
			$('#volumentitulosopc').val('');
			$('#expacciones').val('');
			$('#frecuenciaacciones').val('');
			$('#plazoacciones').val('');
			$('#volumenacciones').val('');
			$('#expvaloresext').val('');
			$('#frecuenciavaloresext').val('');
			$('#plazovaloresext').val('');
			$('#volumenvaloresext').val('');
			$('#exptrackers').val('');
			$('#frecuenciatrackers').val('');
			$('#plazotrackers').val('');
			$('#volumentrackers').val('');
			$('#expcertificadoscap').val('');
			$('#frecuenciacertificadoscap').val('');
			$('#plazocertificadoscap').val('');
			$('#volumencertificadoscap').val('');
			$('#propositoinversion').val('');
			$('#toleranciariesgo').val('');
			$('#horizonteinversion').val('');
			$('#tienelimitante').val('');
